...
@Component({selector: 'app-login-form', templateUrl: './login-form.component.html', styleUrls: ['./login-form.component.css']})
export class LoginFormComponent implements OnInit {
    ...
    onSubmit() {
        if (this.user.email == "admin" && this.user.password == "admin") {
            ...
            this.userService.signInUser(this.user).subscribe(data => {
                console.log(data)
                if (data == null) {
